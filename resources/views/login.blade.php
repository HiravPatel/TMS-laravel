                        ...
                        <form method="POST" action="{{ route('login.post') }}">
                            ...
                            <div class="mb-3">
                                ...
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <a href="{{ route('forgotPasswordForm') }}" class="m-2"
                                    style="text-decoration:none;float:right;">Forgot Password?</a>
                            </div>
                            <button type="submit" class="btn w-100 text-white fw-bold rounded-pill mt-4"
                                style="background-color: #FF6600;">Login</button>
                        </form>
                    </div>
                </div>
            </div>
